...
const Studymaterial = () => {
  ...
  const handleDownload = (content: Content) => {
    ...
    const mediaUrl =
      content.documentUrl || content.videoUrl || content.imageUrl;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access curriculum-aligned study materials, video lessons, and
            interactive quizzes designed for your academic success
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Comprehensive notes with key concepts, formulas, and summaries
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Expert-taught video tutorials covering complex topics with clear
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                Test your understanding with interactive quizzes and get instant
                        ...
                        {getContentByType(selectedType).length === 0 ? (
                          <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 text-lg">
                              No {selectedType.toLowerCase()} available yet
                            </p>
                          </div>
                        ) : (
